...
<div className="perc r">
            ...
            <div className="perc-steps">
              <a href="https://infoprecompilata.agenziaentrate.gov.it/portale/accedi-precompilata" target="_blank" rel="noopener noreferrer" className="ps">🏛 730 Precompilata</a>
              <a href="https://www.agenziaentrate.gov.it" target="_blank" rel="noopener noreferrer" className="ps">📋 Istruzioni 730</a>
              <a href="https://www.inps.it" target="_blank" rel="noopener noreferrer" className="ps">📄 Scarica CU</a>
            </div>
          </div>
          ...
          <div className="sec r" id="cose">
            ...
            <div className="ib tip r"><div className="ib-t">💡 Perché conviene farlo anche se non sei obbligato</div><p>Molte persone non sono tecnicamente obbligate a fare il 730. Ma farlo ti permette di recuperare soldi: <a href="/spese-mediche">spese mediche</a>, affitto (se non hai scelto la <a href="/cedolare-secca">cedolare secca</a>), <a href="/mutuo">mutuo</a>, spese scolastiche, abbonamenti ai trasporti... Se non fai il 730, quei soldi li regali allo Stato. È come avere un buono sconto che scade ogni anno: se non lo usi, lo perdi.</p></div>
...
<div className="sbsec">
            ...
            <a href="https://infoprecompilata.agenziaentrate.gov.it/portale/accedi-precompilata" target="_blank" rel="noopener noreferrer" className="sbtool"><span className="sbtool-i">🏛</span><div><div className="sbtool-n">730 Precompilata</div><div className="sbtool-d">Accedi al sito dell&apos;Agenzia Entrate</div></div></a>
            <a href="https://www.agenziaentrate.gov.it" target="_blank" rel="noopener noreferrer" className="sbtool"><span className="sbtool-i">📋</span><div><div className="sbtool-n">Istruzioni 730</div><div className="sbtool-d">Modello e istruzioni ufficiali</div></div></a>
            <a href="https://www.inps.it" target="_blank" rel="noopener noreferrer" className="sbtool"><span className="sbtool-i">📄</span><div><div className="sbtool-n">Scarica CU</div><div className="sbtool-d">Certificazione Unica dal sito INPS</div></div></a>
          </div>
          <div className="sbsec">
