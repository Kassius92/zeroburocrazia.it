...
import GuideAssegnoInclusioneContent from './GuideAssegnoInclusioneContent';
...
export default function Page() {
  ...
  return (<><SchemaOrg schemas={schemas} /><GuideAssegnoInclusioneContent faqItems={faqItems} /></>);
}
