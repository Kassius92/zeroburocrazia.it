...
import CedolareGuide from './CedolareGuide';
...
export const metadata = {
  ...
  openGraph: { title: 'Cedolare Secca 2026: Aliquote, Calcolo e Quando Conviene', description: 'Cedolare secca 2026: aliquote 21% e 10%, calcolo, F24, affitti brevi. Guida gratuita.', url: 'https://zeroburocrazia.it/cedolare-secca', type: 'article', siteName: 'ZeroBurocrazia', locale: 'it_IT', images: [{ url: 'https://zeroburocrazia.it/ogcedolaresecca.png', width: 1200, height: 630 }] },
...
const faqItems = [
  ...
  { q: "Devo comunicare all\u2019inquilino che scelgo la cedolare secca?", a: "<strong>S\u00ec, con raccomandata</strong>. Con la cedolare rinunci ad aggiornare il canone (incluso adeguamento ISTAT), e l\u2019inquilino deve saperlo. L\u2019unica eccezione: contratti sotto 30 giorni o contratti che gi\u00e0 prevedono la rinuncia agli aggiornamenti." },
];

export default function Page() {
  const schemas = [
    articleSchema({ title: 'Cedolare secca 2026: cos\u2019\u00e8, aliquote, calcolo e quando conviene', description: 'Guida completa alla cedolare secca: aliquote 21% e 10%, confronto IRPEF, affitti brevi 2026, F24 e scadenze.', url: '/cedolare-secca', image: 'ogcedolaresecca.png', datePublished: '2026-03-11', dateModified: '2026-03-28' }),
    faqSchema(faqItems),
  ];
  return (<><SchemaOrg schemas={schemas} /><CedolareGuide faqItems={faqItems} /></>);
}
