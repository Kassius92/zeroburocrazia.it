...
import GuideImuContent from './GuideImuContent';
...
export const metadata = {
  ...
  keywords: ['IMU 2026','calcolo IMU','IMU prima casa','IMU seconda casa','esenzione IMU','scadenze IMU','IMU comodato','aliquote IMU','F24 IMU'],
  alternates: { canonical: 'https://zeroburocrazia.it/imu' },
  openGraph: { title: 'IMU 2026: Calcolo, Aliquote, Esenzioni e Scadenze', url: 'https://zeroburocrazia.it/imu', type: 'article', siteName: 'ZeroBurocrazia', locale: 'it_IT', images: [{ url: 'https://zeroburocrazia.it/ogimu.png', width: 1200, height: 630 }] },
...
export default function Page() {
  ...
  return (
    <>
      ...
      <GuideImuContent faqItems={faqItems} />
    </>
  );
}
