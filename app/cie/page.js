...
export default function Page() {
  const schemas = [
    ...
    faqSchema(faqItems),
    howToSchema({ name: 'Come richiedere la CIE', description: 'Procedura per richiedere la CIE: prenotazione, documenti, costo e ritiro.', totalTime: 'P10D', image: 'ogcie.png', steps: [
      { name: 'Prenota l\'appuntamento', text: 'Vai su prenotazionicie.interno.gov.it e prenota al tuo Comune.' },
      { name: 'Presentati allo sportello', text: 'Porta documento, tessera sanitaria, fototessera. Paga 22,21\u20ac.' },
      { name: 'Ricevi la CIE', text: 'Arriva a casa in 6 giorni lavorativi con PIN e PUK.' },
      { name: 'Attiva CieID', text: 'Scarica l\'app, avvicina la CIE al telefono, inserisci il PIN.' },
    ]}),
  ];
  return (
    <>
      <SchemaOrg schemas={schemas} />
      <CieGuide faqItems={faqItems} />
    </>
  );
}
