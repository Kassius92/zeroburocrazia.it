...
import GuideRistrutturareContent from './GuideRistrutturareContent';
...
const faqItems = [
  ...
  { q: "Posso cumulare bonus ristrutturazione ed Ecobonus?", a: "<strong>S\u00ec, ma non sullo stesso intervento.</strong> Esempio: bonus ristrutturazione per il bagno, Ecobonus per gli infissi." },
  { q: "Posso sostituire la caldaia a gas e detrarre?", a: "<strong>No, dal 2025 \u00e8 esclusa.</strong> La sostituzione di caldaie a combustibili fossili non \u00e8 pi\u00f9 agevolabile. Puoi detrarre pompe di calore, caldaie ibride o biomassa." },
  ...
  { q: "Dal 2027 le aliquote calano?", a: "<strong>S\u00ec.</strong> Nel 2027 si scende al 36% (prima casa) e 30% (altre). Dal 2028 al 30% per tutti. Conviene sostenere le spese entro il 31 dicembre 2026." },
];

export default function Page() {
  const schemas = [
    articleSchema({ title: 'Ristrutturare casa 2026: bonus, detrazioni e permessi', description: 'Ristrutturare casa nel 2026: bonus 50%, ecobonus, permessi e bonifico parlante.', url: '/ristrutturare', image: 'ogristrutturare.png', datePublished: '2026-03-04', dateModified: '2026-03-28' }),
    faqSchema(faqItems),
  ];
  return (
    <>
      <SchemaOrg schemas={schemas} />
      <GuideRistrutturareContent faqItems={faqItems} />
    </>
  );
}
