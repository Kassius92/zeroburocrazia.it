      ...
      <div className="gl-container">
        ...
        <section className="gl-cat">
          ...
          <div className="gl-sm-grid">
            <Link href="/fattura-elettronica" className="gl-sm rv rv-d1"><span className="gl-compact-tag gl-c-coral">Fisco</span><h4>Fattura Elettronica 2026</h4><p>Come fare, software gratuiti, obblighi e conservazione.</p><div className="gl-meta">8 min</div></Link>
            <Link href="/cedolare-secca" className="gl-sm rv rv-d2"><span className="gl-compact-tag gl-c-coral">Fisco</span><h4>Cedolare Secca: Tassazione Affitti</h4><p>Aliquota 21% o 10%, quando conviene, come si applica.</p><div className="gl-meta">8 min</div></Link>
            <Link href="/imu" className="gl-sm rv rv-d3"><span className="gl-compact-tag gl-c-coral">Fisco</span><h4>IMU 2026: Calcolo e Scadenze</h4><p>Chi paga, come si calcola, esenzione prima casa.</p><div className="gl-meta">8 min</div></Link>
            <Link href="/assegno-inclusione" className="gl-sm rv rv-d4"><span className="gl-compact-tag gl-c-coral">Fisco</span><h4>Assegno di Inclusione</h4><p>Ex RdC. Fino a 500&euro;/mese + 303&euro; di affitto.</p><div className="gl-meta">10 min</div></Link>
          </div>
        </section>
        ...
        <section className="gl-cat">
          ...
          <div className="gl-img-grid">
            <Link href="/pec" className="gl-icard rv rv-d1">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-blue">Documenti</span><h3>PEC: Posta Elettronica Certificata</h3><p>Cos&apos;&egrave;, a cosa serve, provider migliori e come attivarla.</p><div className="gl-meta">6 min</div></div>
            </Link>
            <Link href="/codice-fiscale" className="gl-icard rv rv-d2">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-blue">Documenti</span><h3>Codice Fiscale: Richiesta e Duplicato</h3><p>Come richiederlo, duplicato online, tessera sanitaria.</p><div className="gl-meta">5 min</div></div>
            </Link>
            <Link href="/cambio-residenza" className="gl-icard rv rv-d3">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-blue">Documenti</span><h3>Cambio Residenza: Procedura Completa</h3><p>Online su ANPR, tempi, documenti e verifiche.</p><div className="gl-meta">6 min</div></div>
            </Link>
          </div>
        </section>
        ...
        <section className="gl-cat">
          ...
          <div className="gl-text-row">
            <Link href="/tfr" className="gl-tcard rv rv-d1"><span className="gl-compact-tag gl-c-gold">Lavoro</span><h3>TFR: Cos&apos;&egrave; e Come Si Calcola</h3><span className="gl-meta">8 min</span></Link>
          </div>
        </section>
        ...
        <section className="gl-cat">
          ...
          <div className="gl-img-grid">
            <Link href="/compro-casa" className="gl-icard rv rv-d1">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-green">Casa</span><h3>Comprare Casa nel 2026: Guida Completa</h3><p>Mutuo, notaio, imposte, agevolazioni prima casa.</p><div className="gl-meta">15 min</div></div>
            </Link>
            <Link href="/mutuo" className="gl-icard rv rv-d2">
              <div className="gl-icard-img gl-bg-green"><span>Mutuo<br /><em>2026</em></span></div>
              <div className="gl-icard-body"><span className="gl-tag gl-t-green">Casa</span><h3>Mutuo Casa: Calcola la Rata</h3><p>Tasso fisso vs variabile, simulazione, documenti.</p><div className="gl-meta">12 min</div></div>
            </Link>
            <Link href="/ristrutturare" className="gl-icard rv rv-d3">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-green">Casa</span><h3>Ristrutturare Casa: Bonus 50%</h3><p>Come funziona, documenti, bonifico parlante.</p><div className="gl-meta">10 min</div></div>
            </Link>
          </div>
          <div className="gl-text-row" style={{marginTop:'20px'}}>
            <Link href="/bonus-mobili" className="gl-tcard rv rv-d1"><span className="gl-compact-tag gl-c-green">Casa</span><h3>Bonus Mobili 2026</h3><span className="gl-meta">8 min</span></Link>
          </div>
        </section>
        ...
        <section className="gl-cat">
          ...
          <div className="gl-sm-grid">
            <Link href="/congedo-parentale" className="gl-sm rv rv-d1"><span className="gl-compact-tag gl-c-violet">Famiglia</span><h4>Congedo Parentale</h4><p>Durata, retribuzione e come richiederlo.</p><div className="gl-meta">8 min</div></Link>
            <Link href="/mi-sposo" className="gl-sm rv rv-d2"><span className="gl-compact-tag gl-c-violet">Famiglia</span><h4>Mi Sposo: Documenti e Procedura</h4><p>Tutto quello che serve per sposarsi in Italia.</p><div className="gl-meta">8 min</div></Link>
            <Link href="/successione" className="gl-sm rv rv-d3"><span className="gl-compact-tag gl-c-violet">Famiglia</span><h4>Successione</h4><p>Eredit&agrave;, dichiarazione e scadenze.</p><div className="gl-meta">10 min</div></Link>
          </div>
        </section>
        ...
        <section className="gl-cat">
          ...
          <div className="gl-img-grid">
            <Link href="/esenzione-ticket" className="gl-icard rv rv-d1">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-green">Salute</span><h3>Esenzione Ticket: Chi Non Paga</h3><p>Per reddito, per patologia, per et&agrave;. Come richiederla.</p><div className="gl-meta">6 min</div></div>
            </Link>
            <Link href="/bonus-psicologo" className="gl-icard rv rv-d2">
              ...
              <div className="gl-icard-body"><span className="gl-tag gl-t-green">Salute</span><h3>Bonus Psicologo 2026: Fino a 1.500&euro;</h3><p>Requisiti ISEE, domanda INPS, come usarlo.</p><div className="gl-meta">6 min</div></div>
            </Link>
          </div>
        </section>
